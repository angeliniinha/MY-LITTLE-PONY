...
const infos = {
  ...
  twilight: `
    ...
    <img src="twilight.png" alt="Twilight Sparkle" class="info-img">
  ...
  rainbow: `
    <h3>Rainbow Dash</h3>
    <img src="rainbow.png" alt="Rainbow Dash" class="info-img">
  ...
  fluttershy: `
    <h3>Fluttershy</h3>
     <img src="fluttershy.png" alt="" class="info-img">
    <p><strong>Espécie:</strong> Pégaso</p>
  ...
  pinkie: `
    <h3>Pinkie Pie</h3>
     <img src="pinkie.png" alt="Pinkie Pie" class="info-img">
  ...
  rarity: `
    <h3>Rarity</h3>
    <img src="rarity.png" alt="Rarity" class="info-img">
  ...
  applejack: `
    <h3>Applejack</h3>
     <img src="applejack.png" alt="Applejack" class="info-img">
    <p><strong>Espécie:</strong> Pônei Terrestre</p>
  ...
  ponyville: `
    <h3>Ponyville</h3>
     <img src="ponnyville.png" alt="ponyville" class="ponyville-img">
  ...
  canterlot: `
    <h3>Canterlot</h3>
    <img src="canter.jpg" alt="canterlot" class="canterlot-img">
  ...
  cristal: `
    ...
    <img src="cristal.png" alt="reino de cristal" class="cristal-img">
